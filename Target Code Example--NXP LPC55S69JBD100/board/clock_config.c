...
- {id: ENABLE_CLKIN_ENA, value: Enabled}
- {id: ENABLE_SYSTEM_CLK_OUT, value: Enabled}
- {id: SYSCON.AHBCLKDIV.scale, value: '10'}
- {id: SYSCON.MAINCLKSELB.sel, value: SYSCON.PLL0_BYPASS}
- {id: SYSCON.PLL0CLKSEL.sel, value: SYSCON.CLK_IN_EN}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    POWER_SetVoltageForFreq(15000000U);                  /*!< Set voltage for the one of the fastest clock outputs: System clock output */
    CLOCK_SetFLASHAccessCyclesForFreq(15000000U);          /*!< Set FLASH wait states for core */
    ...
    /*!< Set up dividers */
    CLOCK_SetClkDiv(kCLOCK_DivAhbClk, 10U, false);         /*!< Set AHBCLKDIV divider to value 10 */
